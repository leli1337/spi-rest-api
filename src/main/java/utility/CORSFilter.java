...
public class CORSFilter implements Filter {
    ...
    private void addHeadersFor200Response(HttpServletResponse response) {
        ...
        System.out.println("CrossFilter.addHeadersFor200Response");
...
//                alteredResponse.setStatus(HttpServletResponse.SC_UNAUTHORIZED);
//                PrintStream ps = new PrintStream(alteredResponse.getOutputStream());
//                PrintWriter pw = new PrintWriter(ps);
//                pw.print("error");
//                pw.close();
//                ps.close();
//                alteredResponse.getOutputStream().close();
//                return;
